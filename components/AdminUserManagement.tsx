...
const AdminUserManagement: React.FC = () => {
  ...
  // 데이터가 없거나 관리자만 있는 경우 초기화 안내 화면 표시
  if (users.length <= 1) {
    return (
      <>
        <div className="flex flex-col items-center justify-center h-[calc(100vh-100px)] bg-white rounded-2xl border border-slate-200 shadow-sm p-8">
